...
describe('#pgnToPosition pawn moves', () => {
    ...
    test('pawn takes correctly en passant', () => {
        ...
        expect(
            pgn.pgnToPosition(['a3', 'e5', 'h3', 'e4', 'd4', 'exd3'])
        ).toEqual([
            ['bR', 'bN', 'bB', 'bQ', 'bK', 'bB', 'bN', 'bR'],
...
describe('#pgnToPosition Knight moves', () => {
    ...
    test('knight moves correctly when knight column is specified for black', () => {
        expect(
            pgn.pgnToPosition([
                'e4',
                'c6',
    ...
    test('knight moves correctly when knight column is specified for white', () => {
        expect(
            pgn.pgnToPosition([
                'd4',
                'd5',
            ...
            ['bR', 'bN', '00', '00', 'bK', '00', '00', 'bR'],
            ['bP', 'bP', 'bP', '00', '00', 'bP', 'bP', '00'],
            ['00', '00', '00', '00', '00', 'bQ', '00', 'bP'],
            ['00', '00', 'bB', 'wP', 'bP', '00', '00', '00'],
            ['00', '00', 'wB', '00', 'wP', '00', 'bB', '00'],
            ['00', '00', '00', '00', '00', 'wN', '00', '00'],
            ['wP', 'wP', '00', 'wN', '00', 'wP', 'wP', 'wP'],
            ['wR', '00', '00', 'wQ', 'wK', '00', '00', 'wR'],
        ]);
    });
});
...
describe('#pgnToPosition checks and checkmates', () => {
    test('returns correct position when there are checks', () => {
        expect(
            pgn.pgnToPosition(['d4', 'Nf6', 'c4', 'e6', 'Nf3', 'Bb4+'])
        ).toEqual([
...
describe('#pgnToPosition castles', () => {
    test('short castles correctly', () => {
        expect(
            pgn.pgnToPosition(['Nf3', 'd5', 'g3', 'c5', 'Bg2', 'Nc6', 'O-O'])
        ).toEqual([
            ['bR', '00', 'bB', 'bQ', 'bK', 'bB', 'bN', 'bR'],
